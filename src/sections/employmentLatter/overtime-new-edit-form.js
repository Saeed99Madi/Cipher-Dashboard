          ...
          <Box
            ...
            >
               <Stack spacing={1.5}>
                ...
                <Stack spacing={1.5}>
                  <Typography variant="subtitle2">National ID / Iqama</Typography>
            ...
            >
               <Stack spacing={1.5}>
                  ...
                  <RHFTextField name="name" placeholder="Egyptian" />
                </Stack>
                <Stack spacing={1.5}>
                  <Typography variant="subtitle2">Employment Number</Typography>
                  <RHFTextField name="name" type="number" />
                </Stack>
            </Box>
            <Box
            ...
            >
               <Stack spacing={1.5}>
                  ...
                  <RHFTextField name="designation" placeholder="Designation" />
                </Stack>
                <Stack spacing={1.5}>
              <Typography variant="subtitle2">Date Joining</Typography>
              <Controller
                name="datejoining"
                control={control}
            ...
            >
               <Stack spacing={1.5}>
                  <Typography variant="subtitle2">Submit To</Typography>
                  <RHFTextField name="name" placeholder="ex : HR Manager" />
                </Stack>
                <Stack spacing={1.5}>
                  <Typography variant="subtitle2">Salary Section</Typography>
                  <RHFTextField name="name" placeholder="ex : Salary Section" />
                </Stack>
            </Box>
