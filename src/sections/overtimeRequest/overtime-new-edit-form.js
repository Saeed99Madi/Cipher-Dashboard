          ...
          <Box
            ...
            >
               <Stack spacing={1.5}>
                ...
                <Stack spacing={1.5}>
                  ...
                  <RHFTextField name="name" placeholder="Request Type" />
                </Stack>
            </Box>
            ...
            >
               ...
               <Stack spacing={1.5}>
                  ...
                  <RHFTextField name="name" placeholder="Project Name" />
                </Stack>
                <Stack spacing={1.5}>
                  <Typography variant="subtitle2">HRS</Typography>
                  <RHFTextField name="name" placeholder="HRS" />
                </Stack>
                <Stack spacing={1.5}>
                  <Typography variant="subtitle2">Description</Typography>
                  <RHFTextField name="name" placeholder="Description" />
                </Stack>
